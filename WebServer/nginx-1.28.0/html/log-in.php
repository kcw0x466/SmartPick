...
<body>
    ...
    <div class="toast" id="toast">
        ...
        <span id="toast-message">로그인 정보를 확인해주세요.</span>
    </div>
        ...
        <div class="login-form-container">
            ...
            <form id="loginForm" action="api/process_login.php" method="POST">
                ...
                <div class="login-options">
                    ...
                    <a href="id-password.html" class="account-link">비밀번호를 잊으셨나요?</a>
                </div>
            ...
            <div class="account-links">
                ...
                <a href="id-password.html" class="account-link">아이디 찾기</a>
            </div>

            <div class="account-links">
                <span>계정이 없으신가요?</span>
                <a href="register.html" class="account-link">스마트픽에 가입하기</a>
            </div>
