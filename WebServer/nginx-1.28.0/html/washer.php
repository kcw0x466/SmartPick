    ...
    <div class="container">
        ...
        <div class="product-grid" id="productGrid">
            <?php
                ...
                $cursor = $mongoManager->executeQuery("$mongoDBName.products_WashingMachine", $query);
                ...
                foreach ($cursor as $doc) {
                    ...
                    <div class="product-card">
                        <div class="product-quick-actions">
                            ...
                            <button class="quick-action-btn" onclick="window.location.href='product_details.php?category=products_WashingMachine&id=$id'" aria-label="상품 상세보기">
                                <i class="fas fa-eye"></i>
                            </button>
                        </div>
                        <div class="product-image">
                            <img src="/static/img/washer/$id.png" alt="$name">
                        </div>
