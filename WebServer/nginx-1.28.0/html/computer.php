...
<body>
    ...
    <header id="header">
        ...
        <div class="search-container">
            <input type="text" class="search-bar" id="searchBar" name="query" placeholder="찾으시는 상품을 검색해보세요" readonly>
    ...
    <div class="container">
        ...
        <div class="filter-options">
            ...
            <div class="option">100-150만원</div>
            <div class="option">150만원 이상</div>
            <div class="option">인텔</div>
            <div class="option">AMD</div>
            <div class="option">게이밍</div>
            <div class="option">사무용</div>
    ...
    <div class="container">
        ...
        <div class="filter-section">
            <div class="filter-chips">
                ...
                <div class="filter-chip">100-150만원</div>
                <div class="filter-chip">150만원 이상</div>
                <div class="filter-chip">인텔</div>
                <div class="filter-chip">AMD</div>
                <div class="filter-chip">게이밍</div>
                <div class="filter-chip">사무용</div>
            </div>
        ...
        <div class="product-grid" id="productGrid">
            ...
            <div class="product-card">
                <div class="product-quick-actions">
                    <button class="quick-action-btn wishlist-toggle" data-product-id="comp1"
                        data-product-name="삼성전자 올인원 i7 게이밍 데스크탑">
                        <i class="far fa-heart"></i>
                    </button>
                    <button class="quick-action-btn" onclick="window.location.href='product_details.html?id=comp1'"
                        aria-label="상품 상세보기">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="quick-action-btn" onclick="addToCompare('comp1', '삼성전자 올인원 i7 게이밍 데스크탑', 'desktop')"
                        aria-label="상품 비교하기">
                ...
                <div class="product-image">
                    <img src="/api/placeholder/180/120" alt="삼성전자 올인원 i7 게이밍 데스크탑">
                </div>
                <div class="product-info">
                    <div class="product-name">삼성전자 올인원 i7 게이밍 데스크탑</div>
                    <!-- 별점 리뷰 -->
                    ...
                    <div class="product-price">1,250,000원 <span class="original-price">1,550,000원</span></div>
                    <div class="product-specs">Intel Core i7, 16GB RAM, RTX 3060, 512GB SSD, Win11</div>
                    <div class="stock-status in-stock">재고 있음</div>
                    <div class="quick-actions">
                        <button class="cart-button" onclick="addToCart('comp1', '삼성전자 올인원 i7 게이밍 데스크탑')">
            ...
            <div class="product-card">
                <div class="product-quick-actions">
                    <button class="quick-action-btn wishlist-toggle" data-product-id="comp2"
                        data-product-name="LG전자 슬림형 i5 일반 데스크탑">
                        <i class="far fa-heart"></i>
                    </button>
                    <button class="quick-action-btn" onclick="window.location.href='product_details.html?id=comp2'"
                        aria-label="상품 상세보기">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="quick-action-btn" onclick="addToCompare('comp2', 'LG전자 슬림형 i5 일반 데스크탑', 'desktop')"
                        aria-label="상품 비교하기">
                        <i class="fas fa-exchange-alt"></i>
                    </button>
                </div>
                <div class="product-image">
                    <img src="/api/placeholder/180/120" alt="LG전자 슬림형 i5 일반 데스크탑">
                </div>
                <div class="product-info">
                    <div class="product-name">LG전자 슬림형 i5 일반 데스크탑</div>
                    <div class="product-rating">
                        <div class="stars">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                    ...
                    <div class="product-specs">Intel Core i5, 8GB RAM, Intel UHD, 256GB SSD, Win11</div>
                    <div class="stock-status in-stock">재고 있음</div>
                    <div class="quick-actions">
                        <button class="cart-button" onclick="addToCart('comp2', 'LG전자 슬림형 i5 일반 데스크탑')">
                            <i class="fas fa-shopping-cart"></i> 장바구니 추가
                        </button>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-quick-actions">
                    <button class="quick-action-btn wishlist-toggle" data-product-id="comp3"
                        data-product-name="한성컴퓨터 TFG 데스크탑 AMD 라이젠">
                        <i class="far fa-heart"></i>
                    </button>
                    <button class="quick-action-btn" onclick="window.location.href='product_details.html?id=comp3'"
                        aria-label="상품 상세보기">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="quick-action-btn"
                        onclick="addToCompare('comp3', '한성컴퓨터 TFG 데스크탑 AMD 라이젠', 'desktop')" aria-label="상품 비교하기">
                        <i class="fas fa-exchange-alt"></i>
                    </button>
                </div>
                <div class="discount-badge">15%</div>
                <div class="product-image">
                    <img src="/api/placeholder/180/120" alt="한성컴퓨터 TFG 데스크탑 AMD 라이젠">
                </div>
                <div class="product-info">
                    <div class="product-name">한성컴퓨터 TFG 데스크탑 AMD 라이젠</div>
                    <div class="product-rating">
                        <div class="stars">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                    ...
                    <div class="product-price">1,190,000원 <span class="original-price">1,400,000원</span></div>
                    <div class="product-specs">AMD Ryzen 5, 16GB RAM, RX 6600, 500GB SSD, Win11</div>
                    <div class="stock-status low-stock">재고 임박 (4개 남음)</div>
                    <div class="quick-actions">
                        <button class="cart-button" onclick="addToCart('comp3', '한성컴퓨터 TFG 데스크탑 AMD 라이젠')">
                            <i class="fas fa-shopping-cart"></i> 장바구니 추가
                        </button>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-quick-actions">
                    <button class="quick-action-btn wishlist-toggle" data-product-id="comp4"
                        data-product-name="HP Pavilion 일반용 데스크탑">
                        <i class="far fa-heart"></i>
                    </button>
                    <button class="quick-action-btn" onclick="window.location.href='product_details.html?id=comp4'"
                        aria-label="상품 상세보기">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="quick-action-btn" onclick="addToCompare('comp4', 'HP Pavilion 일반용 데스크탑', 'desktop')"
                        aria-label="상품 비교하기">
                        <i class="fas fa-exchange-alt"></i>
                    </button>
                </div>
                <div class="product-image">
                    <img src="/api/placeholder/180/120" alt="HP Pavilion 일반용 데스크탑">
                </div>
                <div class="product-info">
                    <div class="product-name">HP Pavilion 일반용 데스크탑</div>
                    <div class="product-rating">
                        <div class="stars">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                    ...
                    <div class="product-price">780,000원</div>
                    <div class="product-specs">Intel Core i3, 8GB RAM, Intel UHD, 256GB SSD, Win11</div>
                    <div class="stock-status in-stock">재고 있음</div>
                    <div class="quick-actions">
                        <button class="cart-button" onclick="addToCart('comp4', 'HP Pavilion 일반용 데스크탑')">
                            <i class="fas fa-shopping-cart"></i> 장바구니 추가
                        </button>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-quick-actions">
                    <button class="quick-action-btn wishlist-toggle" data-product-id="comp5"
                        data-product-name="MSI MAG 게이밍 데스크탑">
                        <i class="far fa-heart"></i>
                    </button>
                    <button class="quick-action-btn" onclick="window.location.href='product_details.html?id=comp5'"
                        aria-label="상품 상세보기">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="quick-action-btn" onclick="addToCompare('comp5', 'MSI MAG 게이밍 데스크탑', 'desktop')"
                        aria-label="상품 비교하기">
                        <i class="fas fa-exchange-alt"></i>
                    </button>
                </div>
                <div class="product-image">
                    <img src="/api/placeholder/180/120" alt="MSI MAG 게이밍 데스크탑">
                </div>
                <div class="product-info">
                    <div class="product-name">MSI MAG 게이밍 데스크탑</div>
                    <div class="product-rating">
                        <div class="stars">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                    ...
                    <div class="product-price">1,550,000원</div>
                    <div class="product-specs">Intel Core i7, 32GB RAM, RTX 3070, 1TB SSD, Win11</div>
                    <div class="stock-status low-stock">재고 임박 (2개 남음)</div>
                    <div class="quick-actions">
                        <button class="cart-button" onclick="addToCart('comp5', 'MSI MAG 게이밍 데스크탑')">
                            <i class="fas fa-shopping-cart"></i> 장바구니 추가
                        </button>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-quick-actions">
                    <button class="quick-action-btn wishlist-toggle" data-product-id="comp6"
                        data-product-name="ASUS ROG 게이밍 데스크탑">
                        <i class="far fa-heart"></i>
                    </button>
                    <button class="quick-action-btn" onclick="window.location.href='product_details.html?id=comp6'"
                        aria-label="상품 상세보기">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="quick-action-btn" onclick="addToCompare('comp6', 'ASUS ROG 게이밍 데스크탑', 'desktop')"
                        aria-label="상품 비교하기">
                        <i class="fas fa-exchange-alt"></i>
                    </button>
                </div>
                ...
                <div class="product-image">
                    <img src="/api/placeholder/180/120" alt="ASUS ROG 게이밍 데스크탑">
                </div>
                <div class="product-info">
                    <div class="product-name">ASUS ROG 게이밍 데스크탑</div>
                    <div class="product-rating">
                        <div class="stars">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                    ...
                    <div class="product-price">1,350,000원 <span class="original-price">1,500,000원</span></div>
                    <div class="product-specs">Intel Core i7, 16GB RAM, RTX 3060 Ti, 1TB SSD, Win11</div>
                    <div class="stock-status in-stock">재고 있음</div>
                    <div class="quick-actions">
                        <button class="cart-button" onclick="addToCart('comp6', 'ASUS ROG 게이밍 데스크탑')">
                            <i class="fas fa-shopping-cart"></i> 장바구니 추가
                        </button>
                    </div>
                </div>
            ...
            <div class="product-card">
                <div class="product-quick-actions">
                    <button class="quick-action-btn wishlist-toggle" data-product-id="comp7"
                        data-product-name="Dell Alienware Aurora R15 게이밍">
                        <i class="far fa-heart"></i>
                    </button>
                    <button class="quick-action-btn" onclick="window.location.href='product_details.html?id=comp7'"
                        aria-label="상품 상세보기">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="quick-action-btn"
                        onclick="addToCompare('comp7', 'Dell Alienware Aurora R15 게이밍', 'desktop')"
                        aria-label="상품 비교하기">
                        <i class="fas fa-exchange-alt"></i>
                    </button>
                </div>
                <div class="product-image">
                    <img src="/api/placeholder/180/120" alt="Dell Alienware Aurora R15 게이밍">
                </div>
                <div class="product-info">
                    <div class="product-name">Dell Alienware Aurora R15 게이밍</div>
                    <div class="product-rating">
                        <div class="stars">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                    ...
                    <div class="product-specs">Intel Core i9, 32GB RAM, RTX 4070, 2TB SSD, Win11</div>
            ...
            <div class="product-card">
                <div class="product-quick-actions">
                    <button class="quick-action-btn wishlist-toggle" data-product-id="comp8"
                        data-product-name="레노버 Legion 게이밍 데스크탑">
                        <i class="far fa-heart"></i>
                    </button>
                    <button class="quick-action-btn" onclick="window.location.href='product_details.html?id=comp8'"
                        aria-label="상품 상세보기">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="quick-action-btn" onclick="addToCompare('comp8', '레노버 Legion 게이밍 데스크탑', 'desktop')"
                        aria-label="상품 비교하기">
                        <i class="fas fa-exchange-alt"></i>
                    </button>
                </div>
                ...
                <div class="product-image">
                    <img src="/api/placeholder/180/120" alt="레노버 Legion 게이밍 데스크탑">
                </div>
                <div class="product-info">
                    <div class="product-name">레노버 Legion 게이밍 데스크탑</div>
                    <div class="product-rating">
                        <div class="stars">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                    ...
                    <div class="product-price">1,230,000원 <span class="original-price">1,295,000원</span></div>
                    <div class="product-specs">AMD Ryzen 7, 16GB RAM, RTX 3060, 500GB SSD, Win11</div>
                    <div class="stock-status in-stock">재고 있음</div>
                    <div class="quick-actions">
                        <button class="cart-button" onclick="addToCart('comp8', '레노버 Legion 게이밍 데스크탑')">
                            <i class="fas fa-shopping-cart"></i> 장바구니 추가
                        </button>
                    </div>
                </div>
    ...
    <!-- Recent Products Sidebar -->
    <div class="recent-products" id="recentProductsWidget">
